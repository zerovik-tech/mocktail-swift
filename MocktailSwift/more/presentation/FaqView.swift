                ...
                List {
                    ...
                    Section(header:Text("You have further questions?")) {
                        ...
                        ForEach(faqItems) { faqItem in
                            DisclosureGroup() {
                                Text(LocalizedStringKey(faqItem.answer))
                                    .padding()
                                    .font(.callout)
