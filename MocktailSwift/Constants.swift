...
struct MockupType {
    ...
    static let iPhoneMockups : [Mockup] = [
        ...
        Mockup(mockup: MockupList.iPhone12ProMax, baseImageSize: CGSize(width: 1283, height: 2778), radius: 100),
        ...
        Mockup(mockup: MockupList.iPhone13ProMax, baseImageSize: CGSize(width: 1284, height: 2778), radius: 100),
        Mockup(mockup: MockupList.iPhone14, baseImageSize: CGSize(width: 1170, height: 2532), radius: 0),
        Mockup(mockup: MockupList.iPhone14Plus, baseImageSize: CGSize(width: 1285, height: 2778), radius: 300),
        Mockup(mockup: MockupList.iPhone14Pro, baseImageSize: CGSize(width: 1179, height: 2556), radius: 300),
        Mockup(mockup: MockupList.iPhone14ProMax, baseImageSize: CGSize(width: 1290, height: 2796), radius: 300),
        Mockup(mockup: MockupList.iPhone15, baseImageSize: CGSize(width: 1179, height: 2556), radius: 436),
        Mockup(mockup: MockupList.iPhone15Plus, baseImageSize: CGSize(width: 1290, height: 2796), radius: 438),
        Mockup(mockup: MockupList.iPhone15Pro, baseImageSize: CGSize(width: 1179, height: 2556), radius: 458),
        Mockup(mockup: MockupList.iPhone15ProMax, baseImageSize: CGSize(width: 1290, height: 2796), radius: 460),
